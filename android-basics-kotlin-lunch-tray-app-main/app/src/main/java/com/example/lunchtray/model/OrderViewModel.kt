...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        Log.d("LUNCH", "entree ${_entree.value}")
        Log.d("LUNCH", "entree.price ${_entree.value!!.price}")
    ...
    private fun updateSubtotal(itemPrice: Double) {
        Log.d("LUNCH", "itemPrice: ${itemPrice}")
        Log.d("LUNCH", "subtotal: ${subtotal.value}")
        ...
        Log.d("LUNCH", "between subtotal: ${subtotal.value}")
        //  calculate the tax and resulting total
        calculateTaxAndTotal()
        Log.d("LUNCH", "end subtotal: ${subtotal.value}")
    }
